...
* Utility class `JsonUtils` is a flexibility manage any json operations around JsonNode type, both operation serialization and deserialization executed by ObjectMapper performance is over 1000 per nanosecond
